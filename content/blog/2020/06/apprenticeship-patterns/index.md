...
新たな領域**具体的スキル**を修得しようとするとき、**練習、練習、練習**パターンは有効な手段になります。
...
この項の行動は、数冊の本が紹介され、その中から課題を見つけ一定の期間をかけて解くことを通して自分を観察するということです。
